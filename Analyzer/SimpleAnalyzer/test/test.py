...
process.diamondTimingAnalyzer = cms.EDAnalyzer('DiamondTimingAnalyzer',
 ...
 tagCalibrationFile = cms.FileInPath('Analyzer/Calibrations/DiamondCalibration.json')
)
...
process.path = cms.Path(
   ctppsDiamondLocalReconstruction * process.PixelMux_Filter * process.diamondTimingAnalyzer
)
